...
REQUIREMENTS
  ...
  It requires the PHP binary extension PDO.

DOCUMENTATION

 - Documentation for this version is in progress. You can test it from the CLI
   by locating yourself in the htdocs directory and executing 'php index.php'
 - Documentation for version 1.0 is at http://wiki.tlalokes.org
